...
\begin{section}{Homotopieäquivalenz}
	\begin{definition}[homotopieäquivalent]
...
\begin{definition}[Überdeckung, kompakt]
	\begin{itemize}
...
\begin{definition}[kompakte Menge]	Eine \underline{kompakte Menge} ist eine Teilmenge eines vom Kontext her klaren topologischen Raumes, die bezüglich der Teilraumtopologie kompakt ist.
\end{definition}
...
\begin{definition}[Weg, Wegzusammenhangskomponente]
	\begin{itemize}
...
\begin{definition}[Operation, Wirkung]
	\begin{itemize}
...
\begin{theorem}[Gauuß-Bonnet (lokale Version)]
...
\begin{theorem}[Hopfscher Umlaufsatz]
